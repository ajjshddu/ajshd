local danzoID = 11243
local mamoruID = 12395
local izanagiRingID = 11952
local susanooRingID = 14944

local danzoCD = 7 * 60 * 1000
local izanagiCD = 6 * 60 * 1000

local perdaDanzo = "%[50%%%] da sua vida%."
local perdaIzanagi = "passiva do Danzo Ring recuperou %[50%%%] da sua vida%."
...
function ativarProtecao()
  ...
  equiparAteFuncionar(danzoID, SlotFinger)
